export { SKIP } from '../consts.js';

type FlexIteratorOptions<Value = any, Result = Value, Parent = any> = {
 ...
 * @param options
 */
declare class FlexIterator<Value = any, Result = Value, Parent = any> {
    private nodes;
    options: FlexIteratorOptions<Value, Result, Parent>;
    constructor(nodes: Iterable<Value | Iterable<any>>, options?: FlexIteratorOptions<Value, Result, Parent>);
