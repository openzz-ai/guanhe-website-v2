import { MutableRecord } from './mutableRecord.mjs';
import '../misc/union.mjs';
 ...
 * ```
 */
type MutableRecordList<Items, KindKey extends string = "type", Share = unknown, DefaultKind extends keyof Items = never> = MutableRecord<Items, KindKey, Share, DefaultKind>[];
