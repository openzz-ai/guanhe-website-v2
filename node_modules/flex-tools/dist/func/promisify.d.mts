...
type BuildArgsFunction<Args> = (args: Args, callback: (...results: any[]) => void) => any[];
interface PromiseifyOptions<Func extends (...args: any) => any> {
    buildArgs?: BuildArgsFunction<Parameters<Func>>;
    parseCallback?: (results: any[]) => any;
}
interface IncludeCallbackFunction {
}
/**
 *
 *
 ...
 * @returns
 */
declare function promisify<PromisedFunc extends (...args: any[]) => any = AsyncFunction>(fn: (...args: any) => any, options?: PromiseifyOptions<PromisedFunc>): PromisedFunc;

export { type BuildArgsFunction, type IncludeCallbackFunction, type PromiseifyOptions, promisify };
