...
function Se(r, e) {
  ...
  if (s > 0 && e[s - 1] === "**") {
    for (let i = 0; i < s - 1; i++) if (e[i] !== "*" && e[i] !== r[i]) return !1;
    return !0;
  }
  for (let i = 0; i < t; i++) if (e[i] !== "*" && e[i] !== r[i]) return !1;
  return !0;
}
var I = globalThis, Q = I.ShadowRoot && (I.ShadyCSS === void 0 || I.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ee = /* @__PURE__ */ Symbol(), ae = /* @__PURE__ */ new WeakMap(), be = class {
  constructor(r, e, t) {
...
var M = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (r !== null) {
      ...
      if (e !== void 0) for (const [t, s] of e) this.elementProperties.set(t, s);
    }
    this._$Eh = /* @__PURE__ */ new Map();
    for (const [e, t] of this.elementProperties) {
      const s = this._$Eu(e, t);
  ...
  performUpdate() {
    ...
    const e = this._$AL;
    try {
      r = this.shouldUpdate(e), r ? (this.willUpdate(e), this._$EO?.forEach((t) => t.hostUpdate?.()), this.update(e)) : this._$EM();
    } catch (t) {
      throw r = !1, this._$EM(), t;
    }
    r && this._$AE(e);
  }
  willUpdate(r) {
  ...
  _$AE(r) {
    this._$EO?.forEach((e) => e.hostUpdated?.()), this.hasUpdated || (this.hasUpdated = !0, this.firstUpdated(r)), this.updated(r);
  }
  _$EM() {
...
var re = globalThis, he = (r) => r, F = re.trustedTypes, pe = F ? F.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, we = "$lit$", y = `lit$${Math.random().toFixed(9).slice(2)}$`, xe = "?" + y, Ue = `<${xe}>`, A = document, U = () => A.createComment(""), D = (r) => r === null || typeof r != "object" && typeof r != "function", se = Array.isArray, De = (r) => se(r) || typeof r?.[Symbol.iterator] == "function", X = `[ 	
...
var Oe = (r, e) => {
  ...
  for (let a = 0; a < t; a++) {
    ...
    o += n === R ? c + Ue : h >= 0 ? (s.push(m), c.slice(0, h) + we + c.slice(h) + y + _) : c + y + (h === -2 ? a : _);
  }
  ...
  constructor({ strings: e, _$litType$: t }, s) {
    ...
    this.parts = [];
    let o = 0, n = 0;
    const a = e.length - 1, c = this.parts, [m, g] = Oe(e, t);
      ...
      if (i.nodeType === 1) {
        ...
        if (_e.test(i.tagName)) {
          ...
          if (x > 0) {
            ...
            for (let _ = 0; _ < x; _++) i.append(h[_], U()), C.nextNode(), c.push({
              type: 2,
              index: ++o
            });
            i.append(h[x], U());
...
var He = class {
  ...
  _$AI(e, t = this) {
    e = T(this, e, t), D(e) ? e === u || e == null || e === "" ? (this._$AH !== u && this._$AR(), this._$AH = u) : e !== this._$AH && e !== N && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : De(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  k(e) {
    ...
    const t = this._$AH;
    let s, i = 0;
    for (const o of e) i === t.length ? t.push(s = new ke(this.O(U()), this.O(U()), this, this.options)) : s = t[i], s._$AI(o), i++;
  ...
  _$AI(r, e = this, t, s) {
    ...
    let o = !1;
    if (i === void 0) r = T(this, r, e, 0), o = !D(r) || r !== this._$AH && r !== N, o && (this._$AH = r);
    else {
      const n = r;
      let a, c;
      for (r = i[0], a = 0; a < i.length - 1; a++) c = T(this, n[t + a], e, a), c === N && (c = this._$AH[a]), o ||= !D(c) || c !== this._$AH[a], c === u ? r = u : r !== u && (r += (c ?? "") + i[a + 1]), this._$AH[a] = c;
    }
    o && !s && this.j(r);
  }
  j(r) {
...
var Je = (r, e, t) => {
  ...
  if (i === void 0) {
    ...
    s._$litPart$ = i = new oe(e.insertBefore(U(), o), o, void 0, t ?? {});
  }
  return i._$AI(r), i;
...
function l(r, ...e) {
  const t = Y[G] || Y.cn, s = r in t ? t[r] : r, i = /\{[^}]*\}/g;
  let o = 0;
...
var V = class extends k {
  ...
  connectedCallback() {
    super.connectedCallback(), this._addListenerHook(), O(this.lang);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this._removeListenerHook();
  }
  willUpdate(e) {
    super.willUpdate(e), e.has("lang") && O(this.lang);
  }
  _addListenerHook() {
  ...
  getFunctionPosition(e) {
    const t = e.toString(), s = (/* @__PURE__ */ new Error()).stack;
    console.group("函数定位"), console.log("函数代码:", t.substring(0, 200)), console.log("当前调用栈:", s), console.groupEnd(), console.log(e);
  }
  ...
  _printListenerResultToConsole(e) {
    if (e.length === 6) {
      ...
      console.log(t), console.groupEnd();
    }
  }
  _renderReturns(e) {
    if (e.length === 6 && e[5]) {
...
var E = class extends k {
  ...
  _getListenerNode(e) {
    ...
    let t = this.emitter.listeners;
    for (const s of e) if (t[s]) t = t[s];
    else return null;
    return t;
  }
  _findFirstNodeWithListeners() {
  ...
  _refreshData() {
    if (this.emitter && this._expandedNodes.size === 0) {
      ...
      const e = this._findFirstNodeWithListeners();
      e && (this._selectedPath = e, this._listeners = this._getListenerNode(e)?.__listeners || []);
    } else this._selectedPath.length > 0 && (this._listeners = this._getListenerNode(this._selectedPath)?.__listeners || []);
  }
  _handleNodeSelect(e) {
    const t = e.currentTarget.dataset.path;
    if (!t) return;
    const s = t.split("/");
    this._selectedPath = s, this._listeners = this._getListenerNode(s)?.__listeners || [], this.requestUpdate();
  }
  _setupHooks() {
  ...
  _handleNodeToggle(e) {
    ...
    if (!t) return;
    const s = t;
    this._expandedNodes.has(s) ? this._expandedNodes.delete(s) : this._expandedNodes.add(s), this.requestUpdate();
  }
  _handleRefresh() {
    this._refreshData(), this.requestUpdate();
  }
  ...
  _handleKeyDown(e) {
    ...
    switch (e.key) {
      case "Enter":
      case " ":
        e.preventDefault(), this._handleNodeSelect(e);
        break;
      case "ArrowRight":
        e.preventDefault(), this._expandedNodes.has(s) || this._handleNodeToggle(e);
        break;
      case "ArrowLeft":
        e.preventDefault(), this._expandedNodes.has(s) && this._handleNodeToggle(e);
        break;
  ...
  willUpdate(e) {
    super.willUpdate(e), e.has("emitter") && (this.emitter ? this._refreshData() : (this._listeners = [], this._selectedPath = [], this._expandedNodes = /* @__PURE__ */ new Set())), e.has("lang") && O(this.lang);
  }
  connectedCallback() {
...
var v = class extends k {
  constructor(...e) {
    super(...e), this._emitters = [], this._currentEmitterIndex = 0, this._isDropdownOpen = !1, this._emitterLogs = /* @__PURE__ */ new Map(), this._emitterLogIndexes = /* @__PURE__ */ new Map(), this.dark = !1, this.enable = !0, this.maxSize = 500, this.title = "", this.lang = "cn", this.showListeners = !0, this._filterText = "", this._showListeners = !1, this._isShowListeners = !1, this.messages = [], this.logs = [], this._logIndexs = [], this._handleDocumentClick = (t) => {
      ...
      i && !i.contains(s) && (this._isDropdownOpen = !1, this.requestUpdate());
      ...
      if (typeof o == "number") {
        ...
        c !== -1 && (this.logs[c].listeners = a, this.logs[c].updateVersion++, s.map((m, g) => {
          ...
          if (h) {
            ...
            m instanceof Error ? h.status = "error" : h.status = "ok";
          }
        })), delete t.__index;
      }
      this.requestUpdate();
  ...
  connectedCallback() {
    super.connectedCallback(), O(this.lang), this._attach(), document.addEventListener("click", this._handleDocumentClick);
  }
  disconnectedCallback() {
    this._detach(), document.removeEventListener("click", this._handleDocumentClick);
  }
  willUpdate(e) {
    e.has("_filterText") && this._updateFilteredLogs(), e.has("showListenersInLog") && (this._isShowListeners = this.showListeners), e.has("lang") && O(this.lang);
  }
  _getCurrentEmitter() {
    return this._emitters[this._currentEmitterIndex];
  }
  _switchEmitter(e) {
    e !== this._currentEmitterIndex && (this._emitterLogs.set(this._currentEmitterIndex, [...this.logs]), this._emitterLogIndexes.set(this._currentEmitterIndex, [...this._logIndexs]), this._currentEmitterIndex = e, this.logs = this._emitterLogs.get(e) || [], this._logIndexs = this._emitterLogIndexes.get(e) || [], this._reattach(), this._isDropdownOpen = !1, this.requestUpdate());
  }
  _reattach() {
    this._detach(), this.clear(), this._attach();
  }
  _updateFilteredLogs() {
    const e = this._filterText.toLowerCase().trim();
    if (!e) {
      this._logIndexs = this.logs.map((t, s) => s).reverse();
      return;
    }
    this._logIndexs = this.logs.map((t, s) => ({
      log: t,
      index: s
    })).filter(({ log: t }) => {
      const s = t.message.deref();
      return s ? s.type.toLowerCase().includes(e) : !1;
    }).map(({ index: t }) => t).reverse();
  }
  _getListenerMeta(e, t) {
    if (t === void 0) if (e.length === 6) {
      let s;
      const i = e[5];
      i instanceof WeakRef ? s = i.deref() : s = i, s instanceof Error ? t = "error" : t = "ok";
    } else t = "ok";
    return {
      status: t,
      fn: new WeakRef(e[0]),
      name: e[0].name || "anonymous",
      count: `${e[2]}/${e[1] === 0 ? "∞" : e[1]}`,
      tag: e[3],
      flags: e[4],
      result: e[5]
  ...
  _attach() {
    ...
    if (e) {
      const t = e.options;
      e.hooks.BeforeExecuteListener.push(this._onBeforeExecuteListener), e.hooks.AfterExecuteListener.push(this._onAfterExecuteListener), t.debug = !0;
    }
  }
  _detach() {
    const e = this._getCurrentEmitter();
  ...
  clear() {
    this.logs = [], this._logIndexs = [], this.messages = [], this.requestUpdate();
  }
  ...
  _injectEmitterToConsole() {
    const e = this._getEmitterVarName(), t = this._getCurrentEmitter();
    t && (window[e] = t, console.log("FastEvent instance: ", `${e}=`, t));
  }
  renderHeader() {
